...
<div class="ss-form-container">
    ...
    <div class="ss-form"><form action="https://docs.google.com/forms/d/1SYBfS0i9Kib4SP91T1qV-2sqvv14d0h0gSVmBRQuvDA/formResponse" method="POST" id="ss-form" target="_self" onsubmit=""><ol style="padding-left: 0">
                <div class="ss-form-question errorbox-good">
                    <div dir="ltr" class="ss-item ss-item-required ss-text"><div class="ss-form-entry"><label class="ss-q-item-label" for="entry_1019546940"></div><div class="ss-q-title">*お名前
                    ...
                    <div dir="ltr" class="ss-item ss-item-required ss-text"><div class="ss-form-entry"><label class="ss-q-item-label" for="entry_127400455"><div class="ss-q-title">*Eメールアドレス
                                    <label for="itemView.getDomIdToLabel()" aria-label="(Required field)"></label>
                                    <div class="ss-q-help ss-secondary-text" dir="ltr"></div></label>
                    ...
                    <div dir="ltr" class="ss-item  ss-text"><div class="ss-form-entry"><label class="ss-q-item-label" for="entry_1293059246"><div class="ss-q-title">どちらでperaichiをお知りになりましたか？
                                </div>
                                <div class="ss-q-help ss-secondary-text" dir="ltr"></div></label>
                    ...
                    <div dir="ltr" class="ss-item  ss-paragraph-text"><div class="ss-form-entry"><label class="ss-q-item-label" for="entry_2146410725"><div class="ss-q-title">メッセージ
                                </div>
                                <div class="ss-q-help ss-secondary-text" dir="ltr"></div></label>
